...
<span style="font-size: 1em; line-height: 1.6em;">Qué tiene Durandal que no tengan las millones ![:)](http://www.yagoperez.com/wp-includes/images/smilies/simple-smile.png) de librerías MVC, MVVM, MVP que hay por ahí … Pues seguramente nada, pero resulta que está construido sobre otra serie de librerías que conozco más o menos bien y por tanto mi curva de aprendizaje ha sido bastante corta. Si estás en mi situación, conoces estas librerías y estás interesado en crear una aplicación tipo SPA, antes de decidirte a usar los típicos Backbone, AngularJS, EmberJS, etc., echa un ojo a Durandal porque creo que merece la pena.</span>
...
Bueno, para acabar o dejo un enlace para que veais cómo ha quedado [la aplicación que he desarrollado con Durandal](http://stashy.azurewebsites.net)![:)](http://www.yagoperez.com/wp-includes/images/smilies/simple-smile.png)
